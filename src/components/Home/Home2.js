      ...
      <Row>
        <Col md={12} className="home-about-description">
          ...
          <p className="section-text">
            I am a Python Full Stack Developer with experience building
            scalable, secure and maintainable web applications using Django,
            Django REST Framework and React.js. I deliver production-ready
            backend services, REST APIs, JWT authentication and user-centric
